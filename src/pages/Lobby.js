...
function renderUpdateRecord() {
  return (
    <div className="hei30r flowAuto wid30 pTop_2">
      <Timeline>
        ...
        <Timeline.Item>調整 導覽列版面調整 於 2024-07-04</Timeline.Item>
        <Timeline.Item>調整 建築資源列表調整 於 2024-07-04</Timeline.Item>
        <Timeline.Item>
        ...
        <Timeline.Item>
          新增 行軍計算器新增(神器選項) 於 2024-07-11
        </Timeline.Item>
        <Timeline.Item>
          新增 行軍計算器新增(靴子選項) 於 2024-07-15
        </Timeline.Item>
        <Timeline.Item>
